  ...
  return (
    <section id="inicio" className="scroll-mt-24 bg-white">
      <div className="site-container grid min-h-[calc(100svh-4.5rem)] lg:grid-cols-[minmax(0,1.25fr)_minmax(20rem,0.75fr)]">
        <div className="flex flex-col justify-center py-12 sm:py-16 lg:py-24 lg:pr-16 xl:pr-24">
          ...
          <div className="mt-8 border-t border-line pt-5 sm:mt-12 sm:pt-6" data-reveal style={{ '--reveal-delay': '380ms' }}>
