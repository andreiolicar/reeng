...
import preFooterImage from '../assets/pre-footer-reeng-web.jpg'

function PreFooter() {
  return (
    <section className="bg-canvas py-8 sm:py-10 lg:py-12">
      <div className="site-container">
        <div
          className="relative isolate flex min-h-[24rem] items-center justify-center overflow-hidden rounded-[1.25rem] bg-brand-900 px-6 py-16 sm:px-10 lg:min-h-[26rem] lg:px-16"
          data-reveal="image"
        >
          <img
            src={preFooterImage}
          ...
          <div className="mx-auto max-w-4xl text-center text-white" data-reveal>
            ...
            <p className="mx-auto mt-6 max-w-2xl text-base leading-7 text-white/80 sm:text-lg sm:leading-8">
              Converse com a REENG sobre os desafios técnicos do seu empreendimento.
            </p>
            <a
